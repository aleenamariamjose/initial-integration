...
import static com.example.speakout.wifidirect1.MESSAGE_READ;

public class wifidirect1 extends AppCompatActivity {
    ...
    wifidirect1.ServerClass serverClass;
    wifidirect1.ClientClass clientClass;
    wifidirect1.SendReceive sendReceive;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wifidirect1);
        initialWork();
        exqListener();
    }
    ...
    WifiP2pManager.ConnectionInfoListener connectionInfoListener=new WifiP2pManager.ConnectionInfoListener() {
        ...
        public void onConnectionInfoAvailable(WifiP2pInfo wifiP2pInfo) {
            ...
            if (wifiP2pInfo.groupFormed && wifiP2pInfo.isGroupOwner)
            {
                ...
                serverClass=new wifidirect1.ServerClass();
                serverClass.start();
            }else if (wifiP2pInfo.groupFormed)
            {
                connectionStatus.setText("Client");
                clientClass=new wifidirect1.ClientClass(groupOwnerAddress);
                clientClass.start();
            }
        }
    };
    ...
    protected void onResume() {
        super.onResume();
        mReceiver = new WifiDirectBroadcastReceiver1(mManager, mChannel, this);//added
    ...
    public class ServerClass extends Thread{ //to create server side thread
        ...
        public void run() {
            try {
                ...
                sendReceive=new wifidirect1.SendReceive(socket);
                sendReceive.start();
            } catch (IOException e){
                e.printStackTrace();
            }
